...
@dataclass
class WindowElement:
    def __init__(self, *, element_index:int, role:str, subrole:typing.Optional[str], depth:int, element_token:typing.Optional[str], label:typing.Optional[str], description:typing.Optional[str], help:typing.Optional[str], value:typing.Optional[str], value_description:typing.Optional[str], enabled:typing.Optional[bool], selected:typing.Optional[bool], in_web_content:typing.Optional[bool], actions:typing.Optional[typing.List[str]], custom_actions:typing.Optional[typing.List[ElementCustomAction]], parent_index:typing.Optional[int], frame:typing.Optional[ElementFrame], min:typing.Optional[float], max:typing.Optional[float]):
    ...
    def __str__(self):
        return "WindowElement(element_index={}, role={}, subrole={}, depth={}, element_token={}, label={}, description={}, help={}, value={}, value_description={}, enabled={}, selected={}, in_web_content={}, actions={}, custom_actions={}, parent_index={}, frame={}, min={}, max={})".format(self.element_index, self.role, self.subrole, self.depth, self.element_token, self.label, self.description, self.help, self.value, self.value_description, self.enabled, self.selected, self.in_web_content, self.actions, self.custom_actions, self.parent_index, self.frame, self.min, self.max)
    def __eq__(self, other):
